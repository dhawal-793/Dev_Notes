  ...
  return (
    <div className="max-w-screen-lg mx-auto">
      <div className="pb-5 -mt-5 text-center">
        <h1 className="text-3xl italic font-bold">DevNotes</h1>
        <p className="text-base font-semibold">Your Notes secured on the cloud</p>
      </div>
      <div className="p-2 px-4 border border-light rounded-4 custom-shadow mx-[7vw]">
        <h2 className="py-2 text-lg font-semibold text-center">Log In to DevNotes</h2>
        <form>
